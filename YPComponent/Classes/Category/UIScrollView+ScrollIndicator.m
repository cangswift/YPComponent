...
#define JMOScrollIndicatorHeight 2.0f
...
{
    return [objc_getAssociatedObject(self, &viewScrollIndicatorVerticalPosKey) intValue];
}
...
{
    return [objc_getAssociatedObject(self, &viewScrollIndicatorHorizontalPosKey) intValue];
}
...
{
    return [objc_getAssociatedObject(self, &viewScrollIndicatorTypeKey) intValue];
}
...
-(void) enableCustomHorizontalScrollIndicator:(JMOScrollIndicatorPosition)hPos withColor:(UIColor *)indicatorColor withIndicatorStyle:(JMOScrollIndicatorType)style aryCount:(NSUInteger)aryCount grayWidth:(float)grayWidth
{
    ...
    if (hPos == JMOHorizontalScrollIndicatorPositionBottom) {
        float lineWidth;
        if (kScreenWidth > 320) {
            lineWidth = (grayWidth *3.5)/aryCount;
        } else {
            lineWidth = (grayWidth *2.5)/aryCount;
        }
        frame = CGRectMake(0.0f, self.frame.size.height - height - JMOScrollIndicatorBottomSpace, lineWidth,height);
    }
    else {
...
-(void) enableCustomScrollIndicatorsWithScrollIndicatorType:(JMOScrollIndicatorType)type positions:(JMOScrollIndicatorPosition)positions color:(UIColor *)color aryCount:(NSUInteger)aryCount grayWidth:(float)grayWidth
{
    ...
    if (positions & JMOHorizontalScrollIndicatorPositionBottom) {
        [self enableCustomHorizontalScrollIndicator:JMOHorizontalScrollIndicatorPositionBottom withColor:color withIndicatorStyle:type  aryCount:aryCount grayWidth:grayWidth];
    }
    else if (positions & JMOHorizontalScrollIndicatorPositionTop) {
        [self enableCustomHorizontalScrollIndicator:JMOHorizontalScrollIndicatorPositionTop withColor:color withIndicatorStyle:type aryCount:aryCount grayWidth:grayWidth];
    }
...
- (void)refreshHorizontalScrollIndicatorWithAlpha:(CGFloat)alpha
{
    ...
    viewScrollIndicator.left = rect.origin.x;
}
